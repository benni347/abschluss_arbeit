...
func (myTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0x1b, G: 0x2c, B: 0x4d, A: 0xff}
	case theme.ColorNameButton:
		return color.NRGBA{R: 0xa, G: 0x10, B: 0x6f, A: 0x3d}
	...
	case theme.ColorNamePlaceHolder:
		return color.NRGBA{R: 0x3b, G: 0x6a, B: 0xb9, A: 0x91}
	case theme.ColorNamePressed:
		return color.NRGBA{R: 0xfc, G: 0xa5, B: 0xa5, A: 0x66}
	case theme.ColorNamePrimary:
		return color.NRGBA{R: 0x30, G: 0x48, B: 0x77, A: 0xff}
...
func (myTheme) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
		return fontAnonymousProRegularTtf
	}
	if s.Bold {
		if s.Italic {
			return fontOpenSansBoldItalicTtf
		}
		return fontAlefBoldTtf
	}
	if s.Italic {
		return fontOpenSansItalicTtf
	}
	return fontAlefRegularTtf
}
